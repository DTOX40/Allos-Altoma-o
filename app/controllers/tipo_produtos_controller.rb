class TipoProdutosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @tipo_produto.update(tipo_produto_params)
        format.html { redirect_to @tipo_produto, notice: "Tipo produto editado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tipo_produtos_url, notice: "Tipo produto deletado com sucesso." }
